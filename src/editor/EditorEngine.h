 ...
 * uint16_t frameCount;
 *
 * //mahdollisesti id, joka osottaa johonkin listaan, jossa on esim kylttien
 * tekstit, tai funktio...
 ...
 *
 *
 * Ennen staattista lsitaa on solidBlockData buffer data, jossa jokainen bitti
 * kertoo onko palikka solid vai ei.
 *
...
enum class EditMode : char { IDLE, ADD, INSPECT, DELETE };
...
private:
  ...
  void addEntity(sf::Vector2i &position, sf::Vector2i &offset,
                 const int guiIndex); // TODO
  ...
  bool calculateChunkPositions(ChunkPositions &positions,
                               sf::Vector2i &mousePosition,
                               sf::Vector2i &offset,
                               bool disableLastPositionCheck = false);
