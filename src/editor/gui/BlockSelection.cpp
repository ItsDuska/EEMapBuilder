...
int BlockSelection::select(sf::Vector2i& mousePosition)
{
    ...
    {
        return -1; // Ei ole gui:n sisällä, jotain katastrofista on tapahtunut.
    }
    ...
    return -1; // Tähän ei pitäisi koskaan päästä. Jos päästiin niin jotain meni pieleen ja pahasti.
}
